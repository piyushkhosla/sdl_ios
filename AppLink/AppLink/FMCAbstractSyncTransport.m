...
@interface FMCAbstractSyncTransport ()

+ (id) createMutableArrayUsingWeakReferences;

@end

@implementation FMCAbstractSyncTransport
...
- (id) initWithEndpoint:(NSString*) endpoint endpointParam:(NSString*) param {
    if (self = [super init]) {
        ...
        transportListeners = [FMCAbstractSyncTransport createMutableArrayUsingWeakReferences];
...
- (void) addTransportListener:(NSObject<FMCTransportListener>*)listener {
...
- (void) removeTransportListener:(NSObject<FMCTransportListener>*)listener {
	@synchronized (transportListeners) {
...
- (void) notifyTransportConnected {
	...
	for (NSObject<FMCTransportListener>* listener in localListeners) {
