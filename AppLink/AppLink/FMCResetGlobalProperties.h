...
/**
 * @abstract Constructs a new FMCResetGlobalProperties object
 */
-(id) init;
/**
 * @abstract Constructs a new FMCResetGlobalProperties object indicated by the NSMutableDictionary
 * parameter
