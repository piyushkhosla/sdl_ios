 ...
 *
 * Since AppLink 1.0
 * See FMCResetGlobalProperties
 */
@interface FMCSetGlobalProperties : FMCRPCRequest {}

/**
 * @abstract Constructs a new FMCSetGlobalProperties object
 */
-(id) init;
/**
 * @abstract Constructs a new FMCSetGlobalProperties object indicated by the NSMutableDictionary
 * parameter
