...
+ (NSMutableArray*)values
{
    if (FMCPrerecordedSpeech_values == nil)
    {
        FMCPrerecordedSpeech_values = [[NSMutableArray alloc] initWithObjects:
                                       FMCPrerecordedSpeech_HELP_JINGLE,
                                       FMCPrerecordedSpeech_INITIAL_JINGLE,
                                       FMCPrerecordedSpeech_LISTEN_JINGLE,
                                       FMCPrerecordedSpeech_POSITIVE_JINGLE,
                                       FMCPrerecordedSpeech_NEGATIVE_JINGLE,
                                       nil];
    }
