...
/**
 *@abstract  Constructs a newly allocated FMCParameterPermissions object
 */
-(id) init;
/**
 * @abstract Constructs a newly allocated FMCParameterPermissions object indicated by the NSMutableDictionary parameter
