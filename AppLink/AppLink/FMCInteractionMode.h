...
/*!
 @abstract return FMCInteractionMode (Manual / VR / Both)
 @param value NSString
 @result return FMCInteractionMode
 */
+(FMCInteractionMode*) valueOf:(NSString*) value;
/*!
 @abstract store all possible FMCInteractionMode values
 @result return an array with all possible FMCInteractionMode values inside
 */
