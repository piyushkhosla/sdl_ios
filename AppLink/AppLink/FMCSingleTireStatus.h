...
/**
 * @abstract Constructs a newly allocated FMCSingleTireStatus object
 */
-(id) init;

/**
 * @abstract Constructs a newly allocated FMCSingleTireStatus object indicated by the NSMutableDictionary parameter
