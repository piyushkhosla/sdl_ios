...
+ (NSMutableArray*)values
{
    if (FMCAmbientLightStatus_values == nil)
    {
        FMCAmbientLightStatus_values = [[NSMutableArray alloc] initWithObjects:
                                        FMCAmbientLightStatus_NIGHT,
                                        FMCAmbientLightStatus_TWILIGHT_1,
                                        FMCAmbientLightStatus_TWILIGHT_2,
                                        FMCAmbientLightStatus_TWILIGHT_3,
                                        FMCAmbientLightStatus_TWILIGHT_4,
                                        FMCAmbientLightStatus_DAY,
                                        FMCAmbientLightStatus_UNKNOWN,
                                        FMCAmbientLightStatus_INVALID,
                                        nil];
    }
