...
/**
 * @abstract Constructs a newly allocated FMCSyncMsgVersion object
 */
-(id) init;
/**
 * @abstract Constructs a newly allocated FMCSyncMsgVersion object indicated by the NSMutableDictionary parameter
