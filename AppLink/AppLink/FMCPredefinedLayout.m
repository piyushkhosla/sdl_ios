...
+ (NSMutableArray*)values
{
    if (FMCPredefinedLayout_values == nil)
    {
        FMCPredefinedLayout_values = [[NSMutableArray alloc] initWithObjects:
                                      FMCPredefinedLayout_DEFAULT,
                                      FMCPredefinedLayout_MEDIA,
                                      FMCPredefinedLayout_NON_MEDIA,
                                      FMCPredefinedLayout_ONSCREEN_PRESETS,
                                      FMCPredefinedLayout_GRAPHIC_WITH_TEXT,
                                      FMCPredefinedLayout_TEXT_WITH_GRAPHIC,
                                      FMCPredefinedLayout_TILES_ONLY,
                                      FMCPredefinedLayout_TEXTBUTTONS_ONLY,
                                      FMCPredefinedLayout_GRAPHIC_WITH_TILES,
                                      FMCPredefinedLayout_TILES_WITH_GRAPHIC,
                                      FMCPredefinedLayout_GRAPHIC_WITH_TEXT_AND_SOFTBUTTONS,
                                      FMCPredefinedLayout_TEXT_AND_SOFTBUTTONS_WITH_GRAPHIC,
                                      FMCPredefinedLayout_GRAPHIC_WITH_TEXTBUTTONS,
                                      FMCPredefinedLayout_TEXTBUTTONS_WITH_GRAPHIC,
                                      FMCPredefinedLayout_LARGE_GRAPHIC_WITH_SOFTBUTTONS,
                                      FMCPredefinedLayout_DOUBLE_GRAPHIC_WITH_SOFTBUTTONS,
                                      FMCPredefinedLayout_LARGE_GRAPHIC_ONLY,
                                      nil];
    }
