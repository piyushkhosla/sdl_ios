 ...
 * FMCSystemContext=MAIN and no
 * FMCAlert is in progress
 * <p>
 ...
 *
 * Since AppLink 1.0
 * See FMCAlert FMCSetMediaClockTimer
 */
@interface FMCShow : FMCRPCRequest {}

/**
 * @abstract Constructs a new FMCShow object
 */
-(id) init;
/**
 * @abstract Constructs a new FMCShow object indicated by the NSMutableDictionary parameter
