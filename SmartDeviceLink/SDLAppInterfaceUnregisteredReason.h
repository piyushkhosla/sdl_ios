 ...
 *
 */
extern SDLAppInterfaceUnregisteredReason const SDLAppInterfaceUnregisteredProtocolViolation;

/**
 * @abstract App connected to Unsupported HMI Resource.
 *
 */
extern SDLAppInterfaceUnregisteredReason const SDLAppInterfaceUnregisteredUnsupportedHmiResource;
