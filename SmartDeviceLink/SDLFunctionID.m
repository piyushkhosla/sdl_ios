...
- (instancetype)init {
    ...
    self.functionIds = @{
                         ...
                         @59: SDLRPCFunctionNameCreateWindow,
                         @60: SDLRPCFunctionNameDeleteWindow,
                         @61: SDLRPCFunctionNameGetInteriorVehicleDataConsent,
                         @62: SDLRPCFunctionNameReleaseInteriorVehicleDataModule,
