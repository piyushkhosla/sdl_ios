 ...
 *  Convenience init for a Remote Control Capability
 *
 *  @param capability <SDLDisplayCapability *> Describes the extended capabilities of the module's remote control feature
 *  @return             A SDLSystemCapability object
 */
...
/**
 *  Describes the extended capabilities of the module's display capability
 *
 *  Optional
 */
