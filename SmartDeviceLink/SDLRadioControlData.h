 ...
 * Integer
 */
@property (nullable, strong, nonatomic) NSNumber *frequencyInteger;
 ...
 * Integer
 */
@property (nullable, strong, nonatomic) NSNumber *frequencyFraction;
 ...
 */
@property (nullable, strong, nonatomic) NSNumber *availableHDs;
 ...
 * Integer value Min Value - 1 Max Value -3
 */
@property (nullable, strong, nonatomic) NSNumber *hdChannel;
 ...
 */
@property (nullable, strong, nonatomic) NSNumber *signalStrength;
 ...
 * Integer value Min Value - 0 Max Value - 100
 */
@property (nullable, strong, nonatomic) NSNumber *signalChangeThreshold;
 ...
 * Boolean value
 */
@property (nullable, strong, nonatomic) NSNumber *radioEnable;
