...
SDLVehicleDataType const SDLVehicleDataFuelRange = @"VEHICLEDATA_FUELRANGE";
SDLVehicleDataType const SDLVehicleDataAbsState = @"VEHICLEDATA_ABS_STATE";
SDLVehicleDataType const SDLVehicleDataTirePressureValue = @"VEHICLEDATA_TIREPRESSURE_VALUE";
SDLVehicleDataType const SDLVehicleDataTpms = @"VEHICLEDATA_TPMS";
SDLVehicleDataType const SDLVehicleDataTurnSignal = @"VEHICLEDATA_TURNSIGNAL";
