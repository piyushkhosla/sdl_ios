...
- (void)setSteeringWheelLocation:(nullable SDLSteeringWheelLocation)steeringWheelLocation {
    [parameters sdl_setObject:steeringWheelLocation forName:SDLNameSteeringWheelLocation];
}

- (nullable SDLSteeringWheelLocation)steeringWheelLocation {
    return [parameters sdl_objectForName:SDLNameSteeringWheelLocation];
}
