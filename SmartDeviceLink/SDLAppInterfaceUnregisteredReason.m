...
SDLAppInterfaceUnregisteredReason const SDLAppInterfaceUnregisteredProtocolViolation = @"PROTOCOL_VIOLATION";
SDLAppInterfaceUnregisteredReason const SDLAppInterfaceUnregisteredUnsupportedHmiResource = @"UNSUPPORTED_HMI_RESOURCE";
