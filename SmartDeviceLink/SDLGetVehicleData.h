 ...
 * subscribed.
 */
@property (nullable, strong, nonatomic) NSNumber *fuelRange;

/**
 * @abstract A boolean value. If true, means the abs_State data has been
 * subscribed.
 */
@property (nullable, strong, nonatomic) NSNumber *abs_State;

/**
 * @abstract A boolean value. If true, means the tirePressureValue data has been
 * subscribed.
 */
@property (nullable, strong, nonatomic) NSNumber *tirePressureValue;

/**
 * @abstract A boolean value. If true, means the tpms data has been
 * subscribed.
 */
@property (nullable, strong, nonatomic) NSNumber *tpms;

/**
 * @abstract A boolean value. If true, means the turnSignal data has been
 * subscribed.
 */
@property (nullable, strong, nonatomic) NSNumber *turnSignal;
