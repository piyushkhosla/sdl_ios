 ...
 */
@property (strong, nonatomic, nullable) SDLVehicleDataResult *abs_State;

/**
 * @abstract A SDLVehicleDataResult* value. The status of the tirePressureValue.
 */
@property (strong, nonatomic, nullable) SDLVehicleDataResult *tirePressureValue;

/**
 * @abstract A SDLVehicleDataResult* value. The status of the tpms.
 */
@property (strong, nonatomic, nullable) SDLVehicleDataResult *tpms;
