 ...
 */
extern SDLVehicleDataType const SDLVehicleDataFuelRange;

/**
 * @abstract SDLVehicleDataType: *VEHICLEDATA_ABS_STATE*
 */
extern SDLVehicleDataType const SDLVehicleDataAbsState;

/**
 * @abstract SDLVehicleDataType: *VEHICLEDATA_TIREPRESSURE_VALUE*
 */
extern SDLVehicleDataType const SDLVehicleDataTirePressureValue;

/**
 * @abstract SDLVehicleDataType: *VEHICLEDATA_Tpms*
 */
extern SDLVehicleDataType const SDLVehicleDataTpms;

/**
 * @abstract SDLVehicleDataType: *VEHICLEDATA_TURNSIGNAL*
 */
extern SDLVehicleDataType const SDLVehicleDataTurnSignal;
